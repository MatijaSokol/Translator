...
android {
    namespace = "com.matijasokol.translator.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.matijasokol.translator.android"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.matijasokol.translator.TestHiltRunner"
    }
    buildFeatures {
        compose = true
    }
